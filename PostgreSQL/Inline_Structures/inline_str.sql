...
SELECT DISTINCT
    ...
    b."InlineStrID"
INTO
    "Dzierzgon".pointsinlinestr
FROM
    "Dzierzgon"."StreamCenterlines" AS a,
    "Dzierzgon"."Inline_Structures" AS b
WHERE
    a.geom && b.geom AND
    ST_Intersects(a.geom, b.geom);
...
INTO
    "Dzierzgon".tempstatinlinestr
FROM
    "Dzierzgon"."StreamCenterlines" AS a,
    "Dzierzgon".pointsinlinestr AS b
WHERE
...
SET
    "Station" = b."Station"
FROM
    "Dzierzgon".tempstatinlinestr AS b
WHERE
    a."InlineStrID" = b."InlineStrID";
