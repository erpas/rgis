...
SELECT
    ...
    b."LateralSID"
INTO
    "Dzierzgon".riverclosestpoint1
FROM
    "Dzierzgon"."StreamCenterlines" AS a,
    "Dzierzgon"."LateralStructures" AS b
ORDER BY
    b."LateralSID";
...
INTO
    "Dzierzgon".tempstatclosestpoints
FROM
    "Dzierzgon"."StreamCenterlines" AS a,
    "Dzierzgon".riverclosestpoint2 AS b
WHERE
    a."ReachCode" = b."ReachCode"
ORDER BY
    "ReachCode", "Station";
        
--- Update Lateral_Structure layer by data from previous step basing on LateralStrID
UPDATE "Dzierzgon"."LateralStructures" AS a
SET
    "Station" = b."Station",
    "ReachCode" = b."ReachCode",
    "RiverCode" = b."RiverCode"
FROM
    "Dzierzgon".tempstatclosestpoints AS b
WHERE
    a."LateralSID" = b."LateralSID";
