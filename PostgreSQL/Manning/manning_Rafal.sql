...
INTO "Dzierzgon".intercrossection
...
INTO "Dzierzgon".intercrossectiondump
...
INTO "Dzierzgon".single_line
FROM "Dzierzgon"."XSCutLines"
ORDER BY "XsecID";
...
INTO "Dzierzgon".shiftpoints
FROM "Dzierzgon".intercrossectiondump
ORDER BY "XsecID";
...
SELECT
    ...
    "N_Value",
    "LUCode"
INTO "Dzierzgon"."Manning"
FROM "Dzierzgon".tempmann;

DROP TABLE
    "Dzierzgon".intercrossection,
    "Dzierzgon".intercrossectiondump,
    "Dzierzgon".single_line,
    "Dzierzgon".shiftpoints,
    "Dzierzgon".tempmann,
    "Dzierzgon".ludump
