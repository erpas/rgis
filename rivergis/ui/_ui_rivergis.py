...
#
# Created: Mon Oct 19 13:16:48 2015
...
class Ui_RiverGIS(object):
    def setupUi(self, RiverGIS):
        ...
        self.actionCreate2dAreaPerimeter.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras2dareaCreate.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASCreate2dAreaPoints.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/loadWselHdf.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLoad_2D_WSEL_from_HDF.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/createWselRaster.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASWaterSurfaceGeneration.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/importFromIsok.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImportRiverFromIsokp.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/refreshConnections.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRefreshConnections.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/createDepthsAndRange.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASFloodplainDelineation.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/rasImportHdfIntoRdb.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASImportRasData.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras2dareaSaveToGeo.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASSave2DPointsToHECRASGeometry.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras2dareaPreview.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASPreview2DMesh.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/createPgTables.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASCreateRdbTables.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsMannings.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASManningsNValues.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dCreateRASImport.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASCreateRASGISImport.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dStreamCenterlinesTopology.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASTopology1D.setIcon(icon21)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dStreamCenterlinesLengthsStations.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASLengthsStations.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dStreamCenterlinesAll.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASStreamCenterlineAll.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsRiverNames.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSRiverReachNames.setIcon(icon24)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsStationing.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSStationing.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsBanks.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSBankStations.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsDSLenghts.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSDownstreamReachLengths.setIcon(icon27)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsElevations.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSElevations.setIcon(icon28)
        self.actionRASXSElevations.setObjectName(_fromUtf8("actionRASXSElevations"))
        self.actionRASXSAll = QtGui.QAction(RiverGIS)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsAll.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSAll.setIcon(icon29)
        self.actionRASXSAll.setObjectName(_fromUtf8("actionRASXSAll"))
        self.actionRASImportLayersIntoRdbTables = QtGui.QAction(RiverGIS)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/importLayersIntoRdb.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASImportLayersIntoRdbTables.setIcon(icon30)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsLevees.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASLevees.setIcon(icon31)
        self.actionRASLevees.setObjectName(_fromUtf8("actionRASLevees"))
        self.actionRASIneffectiveFlowAreas = QtGui.QAction(RiverGIS)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsIneffective.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASIneffectiveFlowAreas.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsBlockedObs.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASBlockedObstructions.setIcon(icon33)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/loadRdbTablesIntoQgis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASLoadRdbTablesIntoQGIS.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/dtmSetup.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASDTMSetup.setIcon(icon35)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsUpdate.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSUpdateInsertMeasuredPoints.setIcon(icon36)
        ...
        self.actionRASSATerrainPointExtraction.setIcon(icon38)
        ...
        self.actionAaa_2 = QtGui.QAction(RiverGIS)
        self.actionAaa_2.setObjectName(_fromUtf8("actionAaa_2"))
        ...
        self.settingsToolBar.addAction(self.actionRefreshConnections)
        self.settingsToolBar.addAction(self.actionRASCreateRdbTables)
        self.settingsToolBar.addAction(self.actionRASImportLayersIntoRdbTables)
        self.settingsToolBar.addAction(self.actionRASLoadRdbTablesIntoQGIS)
        self.dbToolBar.addAction(self.actionRASDTMSetup)
    ...
    def retranslateUi(self, RiverGIS):
        ...
        self.actionRASFloodplainDelineation.setText(_translate("RiverGIS", "Floodplain Delineation", None))
        self.actionLoad_1D_WSEL_from_HDF.setText(_translate("RiverGIS", "Load 1D WSEL from HDF", None))
        self.actionRASImportRasData.setText(_translate("RiverGIS", "Import RAS Results From HDF", None))
