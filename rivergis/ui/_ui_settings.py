...
#
# Created: Tue Oct 27 15:52:50 2015
...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.groupBox = QgsCollapsibleGroupBox(self.mOptionsScrollAreaContents_01)
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.groupBox)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.debugModeChbox = QtGui.QCheckBox(self.groupBox)
        self.debugModeChbox.setObjectName(_fromUtf8("debugModeChbox"))
        self.verticalLayout_2.addWidget(self.debugModeChbox)
        self.rgisAlwaysOnTopChbox = QtGui.QCheckBox(self.groupBox)
        self.rgisAlwaysOnTopChbox.setObjectName(_fromUtf8("rgisAlwaysOnTopChbox"))
        self.verticalLayout_2.addWidget(self.rgisAlwaysOnTopChbox)
        ...
        self.verticalLayout_7 = QtGui.QVBoxLayout(self.mGroupBox)
        self.verticalLayout_7.setObjectName(_fromUtf8("verticalLayout_7"))
        self.db_overwriteChbox = QtGui.QCheckBox(self.mGroupBox)
        self.db_overwriteChbox.setObjectName(_fromUtf8("db_overwriteChbox"))
        self.verticalLayout_7.addWidget(self.db_overwriteChbox)
        self.db_loadAllChbox = QtGui.QCheckBox(self.mGroupBox)
        self.db_loadAllChbox.setObjectName(_fromUtf8("db_loadAllChbox"))
        self.verticalLayout_7.addWidget(self.db_loadAllChbox)
        self.verticalLayout_6.addWidget(self.mGroupBox)
        ...
        self.groupBox_5 = QgsCollapsibleGroupBox(self.mOptionsScrollAreaContents_04)
        self.groupBox_5.setObjectName(_fromUtf8("groupBox_5"))
        self.verticalLayout_8 = QtGui.QVBoxLayout(self.groupBox_5)
        self.verticalLayout_8.setObjectName(_fromUtf8("verticalLayout_8"))
        self.dtm_selectAllChbox = QtGui.QCheckBox(self.groupBox_5)
        self.dtm_selectAllChbox.setObjectName(_fromUtf8("dtm_selectAllChbox"))
        self.verticalLayout_8.addWidget(self.dtm_selectAllChbox)
        self.dtm_listView = QtGui.QListView(self.groupBox_5)
        ...
        self.verticalLayout_8.addWidget(self.dtm_listView)
        self.label_2 = QtGui.QLabel(self.groupBox_5)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.verticalLayout_8.addWidget(self.label_2)
        self.dtm_chunksize = QtGui.QSpinBox(self.groupBox_5)
        ...
        self.verticalLayout_8.addWidget(self.dtm_chunksize)
    ...
    def retranslateUi(self, Settings):
        ...
        self.groupBox.setTitle(_translate("Settings", "Application", None))
        ...
        self.mGroupBox.setTitle(_translate("Settings", "Database", None))
        ...
        self.groupBox_5.setTitle(_translate("Settings", "Rasters selection", None))
