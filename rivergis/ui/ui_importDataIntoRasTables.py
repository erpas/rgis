...
#
# Created: Wed Sep 23 23:10:56 2015
...
class Ui_importDataIntoRasTables(object):
    def setupUi(self, importDataIntoRasTables):
        ...
        importDataIntoRasTables.resize(376, 586)
        ...
        self.horizontalLayout_10.addWidget(self.cboStructures)
        ...
        self.horizontalLayout_11.addWidget(self.cboStructureMeshSizeAlongAttr)
        ...
        self.horizontalLayout_12.addWidget(self.cboStructureMeshSizeAcrossAttr)
        ...
        self.horizontalLayout_13.addWidget(self.cboStructureMeshRowsAttr)
    ...
    def retranslateUi(self, importDataIntoRasTables):
        ...
        self.groupBox.setTitle(_translate("importDataIntoRasTables", "2D Areas Layer", None))
        ...
        self.AreaNameAttributeLabel_2.setText(_translate("importDataIntoRasTables", "Default mesh size attribute", None))
        ...
        self.AreaNameAttributeLabel_4.setText(_translate("importDataIntoRasTables", "Mesh size along structure", None))
        self.label_16.setText(_translate("importDataIntoRasTables", "Mesh size across structure", None))
        self.label_17.setText(_translate("importDataIntoRasTables", "Mesh rows number", None))
        self.groupBox_3.setTitle(_translate("importDataIntoRasTables", "Structure breakpoints", None))
