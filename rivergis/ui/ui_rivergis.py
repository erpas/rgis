...
#
# Created: Tue Oct 13 10:45:11 2015
...
class Ui_RiverGIS(object):
    def setupUi(self, RiverGIS):
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dSAElevVolume.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASAElevationVolumeData.setIcon(icon30)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dSATerPtExtract.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASSATerrainPointExtraction.setIcon(icon31)
