...
#
# Created: Thu Oct 22 23:26:53 2015
...
class Ui_RiverGIS(object):
    def setupUi(self, RiverGIS):
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/importFromIsok.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImportRiverFromIsokp.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/refreshConnections.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRefreshConnections.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/createDepthsAndRange.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASFloodplainDelineation.setIcon(icon13)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/rasImportHdfIntoRdb.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASImportRasData.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras2dareaSaveToGeo.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASSave2DPointsToHECRASGeometry.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras2dareaPreview.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASPreview2DMesh.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/createPgTables.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASCreateRdbTables.setIcon(icon17)
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsMannings.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASManningsNValues.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dCreateRASImport.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASCreateRASGISImport.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dStreamCenterlinesTopology.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASTopology1D.setIcon(icon20)
        self.actionRASTopology1D.setObjectName(_fromUtf8("actionRASTopology1D"))
        self.actionRASLengthsStations = QtGui.QAction(RiverGIS)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dStreamCenterlinesLengthsStations.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASLengthsStations.setIcon(icon21)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dStreamCenterlinesAll.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASStreamCenterlineAll.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsRiverNames.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSRiverReachNames.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsStationing.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSStationing.setIcon(icon24)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsBanks.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSBankStations.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsDSLenghts.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSDownstreamReachLengths.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsElevations.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSElevations.setIcon(icon27)
        self.actionRASXSElevations.setObjectName(_fromUtf8("actionRASXSElevations"))
        self.actionRASXSAll = QtGui.QAction(RiverGIS)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsAll.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSAll.setIcon(icon28)
        self.actionRASXSAll.setObjectName(_fromUtf8("actionRASXSAll"))
        self.actionRASImportLayersIntoRdbTables = QtGui.QAction(RiverGIS)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/importLayersIntoRdb.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASImportLayersIntoRdbTables.setIcon(icon29)
        ...
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsLevees.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASLevees.setIcon(icon30)
        self.actionRASLevees.setObjectName(_fromUtf8("actionRASLevees"))
        self.actionRASIneffectiveFlowAreas = QtGui.QAction(RiverGIS)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsIneffective.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASIneffectiveFlowAreas.setIcon(icon31)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsBlockedObs.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASBlockedObstructions.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/loadRdbTablesIntoQgis.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASLoadRdbTablesIntoQGIS.setIcon(icon33)
        ...
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/dtmSetup.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASDTMSetup.setIcon(icon34)
        ...
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dXsUpdate.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASXSUpdateInsertMeasuredPoints.setIcon(icon35)
        ...
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dSAElevVolume.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASSAElevationVolumeData.setIcon(icon36)
        ...
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(_fromUtf8(":/rivergis/icons/ras1dSATerPtExtract.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRASSATerrainPointExtraction.setIcon(icon37)
